 ...
 */
function local_overflow_file_rewrite_urls_to_pluginfile($text, $draftitemid, $usercontext, $forcehttps = false) {
    global $CFG;
 ...
 */
function local_overflow_file_save_draft_area_files($draftitemid, $contextid, $component, $filearea, $itemid, $usercontext, array $options=null, $text=null, $forcehttps=false) {
    ...
    if (is_null($text)) {
        ...
        return local_overflow_file_rewrite_urls_to_pluginfile($text, $draftitemid, $usercontext, $forcehttps);
    }
}
// phpcs:enable

/**
 * This is a function that checks all overflow posts for links to user's draft files
 * and moves them to the appropriate file area.
 * @return int amount of changed files.
 */
function local_overflow_move_draftfiles_to_permanent_filearea() {
    global $CFG, $DB;
    ...
    foreach ($posts as $post) {
        ...
        $post->message = local_overflow_file_save_draft_area_files($draftid, $context->id, 'local_overflow', 'post',
