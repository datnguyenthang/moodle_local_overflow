 ...
 *
 * @module     local_overflow/warnmodechange
...
export function init(previousSetting) {
    Prefetch.prefetchStrings('local_overflow', ['switchtooptional', 'switchtoauto']);
    ...
    form.onsubmit = async(e) => {
        ...
        await Notification.confirm(
            ...
            await getString(value == 0 ? 'switchtooptional' : 'switchtoauto', 'local_overflow'),
            await getString('confirm'),
