...
$string['overflow:myaddinstance'] = 'Local Overflow';
...
$string['allowanonymous_desc'] = 'Allow teachers to put overflow forums into anonymous question or full anonymous mode. Once enabled, anonymous forums will stay anonymous, even when this setting is disabled. If you really want to, you can reset anonymity in all forums <a href="{$a}">here</a>.';
$string['allowreputation'] = 'Sum reputation.';
...
$string['allownegativereputation_help'] = 'If set to yes, the users reputation or within a module can be negative. If set to no, the reputation will stop to decrease at zero.';
...
$string['configallowreputation'] = 'Allow to sum the reputation of all instances?';
...
$string['configforcedreadtracking'] = 'Allows overflows to be set to forced read tracking. Will result in decreased performance for some users, particularly on courses with many overflows and posts. When off, any overflows previously set to Forced are treated as optional.';
$string['configmanydiscussions'] = 'Maximum number of discussions shown in a overflow instance per page';
$string['configmaxattachments'] = 'Default maximum number of attachments allowed per post.';
$string['configmaxbytes'] = 'Default maximum size for all forum attachments on the site (subject to limits and other local settings)';
...
$string['configpreferteachersmark'] = 'The answer marked as solution by a owner are prioritized over the answer marked as helpful by the starter of the discussion.';
$string['configreputationnotnegative'] = 'Prohibits the users reputation being negative.';
$string['configshowuserstats'] = 'Allow teachers to see statistics summarizing the activity of users in overflows.';
$string['configtrackingtype'] = 'Default setting for read tracking.';
$string['configtrackoverflow'] = 'Set to \'yes\' if you want to track read/unread for each user.';
...
$string['confirmsubscribediscussion'] = 'Do you really want to subscribe to discussion \'{$a->discussion}\' in forum \'{$a->overflow}\'?';
$string['confirmunsubscribe'] = 'Do you really want to unsubscribe from overflow \'{$a}\'?';
$string['confirmunsubscribediscussion'] = 'Do you really want to unsubscribe from discussion \'{$a->discussion}\' in overflow \'{$a->overflow}\'?';
...
$string['widereputation'] = 'Cross module reputation?';
$string['widereputation_help'] = 'If set to yes, the users reputations of all overflow modules in this course will be summed.';
$string['crontask'] = 'overflow maintenance jobs';
...
$string['discussionnownotsubscribed'] = '{$a->name} will NOT be notified of new posts in \'{$a->discussion}\' of \'{$a->overflow}\'';
$string['discussionnowsubscribed'] = '{$a->name} will be notified of new posts in \'{$a->discussion}\' of \'{$a->overflow}\'';
...
$string['generaloverflows'] = 'Forums in this course';
...
$string['markoverflowreadsuccessful'] = 'All posts have been marked as read.';
...
$string['modulename'] = 'Overflow';
$string['modulename_help'] = 'The overflow module enables participants to use a question-answer forum structure. The forum display is non-chronological as the ordering depends on collaborative voting instead of on time.';
$string['modulenameplural'] = 'Overflows';
$string['overflow'] = 'Overflow';
$string['overflow:addinstance'] = 'Add a new overflow instance';
$string['overflow:allowforcesubscribe'] = 'Allow forced subscription';
$string['overflow:createattachment'] = 'Create attachments';
$string['overflow:deleteanypost'] = 'Delete posts';
$string['overflow:deleteownpost'] = 'Delete own posts';
$string['overflow:editanypost'] = 'Edit posts';
$string['overflow:managesubscriptions'] = 'Manage subscriptions';
$string['overflow:marksolved'] = 'Mark a post as solution';
$string['overflow:movetopic'] = 'Move Topic to another Moddleoverflow Forum';
$string['overflow:ratehelpful'] = 'Mark a post as helpful';
$string['overflow:ratepost'] = 'Rate a post';
$string['overflow:replypost'] = 'Reply in discussion';
$string['overflow:reviewpost'] = 'Review (approve or reject) posts';
$string['overflow:startdiscussion'] = 'Start a discussion';
$string['overflow:viewanyrating'] = 'View total ratings that anyone received';
$string['overflow:viewdiscussion'] = 'View discussion';
$string['overflowauthorhidden'] = 'Author (hidden)';
$string['overflowbodyhidden'] = 'This post cannot be viewed by you, probably because you have not posted in the discussion, the maximum editing time hasn\'t passed yet, the discussion has not started or the discussion has expired.';
$string['overflowfieldset'] = 'Custom example fieldset';
$string['overflowname'] = 'Name';
$string['overflows'] = 'Overflows';
$string['overflowsubjecthidden'] = 'Subject (hidden)';
$string['movetopicicon'] = 'Move this discussion to another overflow';
...
$string['nopostoverflow'] = 'Sorry, you are not allowed to post to this forum.';
$string['norateoverflow'] = 'Sorry, you are not allowed to vote in this forum.';
$string['noratingchangeallowed'] = 'You are not allowed to change your ratings.';
$string['notexists'] = 'Discussion no longer exists';
$string['nothing'] = 'Nothing';
$string['notpartofdiscussion'] = 'This post is not part of a discussion!';
$string['notrackoverflow'] = 'Don\'t track unread posts';
...
$string['nownotsubscribed'] = '{$a->name} will NOT be notified of new posts in \'{$a->overflow}\'';
$string['nownottracking'] = '{$a->name} is no longer tracking \'{$a->overflow}\'.';
$string['nowsubscribed'] = '{$a->name} will be notified of new posts in \'{$a->overflow}\'';
$string['nowtracking'] = '{$a->name} is now tracking \'{$a->overflow}\'.';
...
$string['pluginadministration'] = 'Overflow administration';
$string['pluginname'] = 'Overflow';
...
$string['posts'] = 'Posts';
$string['posttooverflow'] = 'Post to forum';
...
$string['privacy:grade'] = 'Your grade for this overflow forum.';
$string['privacy:metadata:core_files'] = 'overflow stores files which have been uploaded by the user to form part of a forum post.';
$string['privacy:metadata:overflow_discuss_subs'] = 'Information about the subscriptions to individual forum discussions. This includes when a user has chosen to subscribe to a discussion or to unsubscribe from one where they would otherwise be subscribed.';
$string['privacy:metadata:overflow_discuss_subs:discussion'] = 'The ID of the discussion that was subscribed / unsubscribed.';
$string['privacy:metadata:overflow_discuss_subs:preference'] = 'The start time of the subscription.';
$string['privacy:metadata:overflow_discuss_subs:userid'] = 'The ID of the user who changed the subscription settings.';
$string['privacy:metadata:overflow_discussions'] = 'Information about forum discussions. This includes which discussions a user has started.';
$string['privacy:metadata:overflow_discussions:name'] = 'The name of the discussion.';
$string['privacy:metadata:overflow_discussions:timemodified'] = 'The time when the discussion (e.g. a post) was last modified.';
$string['privacy:metadata:overflow_discussions:userid'] = 'The ID of the user who started the discussion.';
$string['privacy:metadata:overflow_discussions:usermodified'] = 'The ID of the last user who modified the discussion';
$string['privacy:metadata:overflow_grades'] = 'Information about the grade a user got for his contribution in a forum.';
$string['privacy:metadata:overflow_grades:grade'] = 'The grade the user got.';
$string['privacy:metadata:overflow_grades:overflowid'] = 'The ID of the overflow forum in which he got the grade.';
$string['privacy:metadata:overflow_grades:userid'] = 'The ID of the user who got the grade.';
$string['privacy:metadata:overflow_posts'] = 'Information about forum posts. This includes data of posts a user has written.';
$string['privacy:metadata:overflow_posts:created'] = 'The date this post was created.';
$string['privacy:metadata:overflow_posts:discussion'] = 'The ID of the discussion this post is contributing to.';
$string['privacy:metadata:overflow_posts:message'] = 'The text of this post.';
$string['privacy:metadata:overflow_posts:modified'] = 'The last date this post was modified.';
$string['privacy:metadata:overflow_posts:parent'] = 'The ID of the post this post is referring to.';
$string['privacy:metadata:overflow_posts:userid'] = 'The ID of the user who submitted this post.';
$string['privacy:metadata:overflow_ratings'] = 'Information about ratings of posts. This includes when a user has rated a post and its specific rating.';
$string['privacy:metadata:overflow_ratings:discussionid'] = 'The ID of the discussion the rated post is part of.';
$string['privacy:metadata:overflow_ratings:firstrated'] = 'The date the rating was submitted.';
$string['privacy:metadata:overflow_ratings:lastchanged'] = 'The date the rating was changed the last time.';
$string['privacy:metadata:overflow_ratings:overflowid'] = 'The ID of the overflow forum that contains the rated post.';
$string['privacy:metadata:overflow_ratings:postid'] = 'The ID of the post that was rated.';
$string['privacy:metadata:overflow_ratings:rating'] = 'The submitted rating. 0 = neutral, 1 = negative, 2 = positive, 3 = helpful, 4 = solution';
$string['privacy:metadata:overflow_ratings:userid'] = 'The ID of the user who submitted the rating.';
$string['privacy:metadata:overflow_read'] = 'Information about read tracking of posts. This includes when posts were read by a user.';
$string['privacy:metadata:overflow_read:discussionid'] = 'The ID of the discussion the read post belongs to,';
$string['privacy:metadata:overflow_read:firstread'] = 'The date the post was read the first time.';
$string['privacy:metadata:overflow_read:lastread'] = 'The date the post was read the last time by the user.';
$string['privacy:metadata:overflow_read:postid'] = 'The ID of the post that has been read.';
$string['privacy:metadata:overflow_read:userid'] = 'The ID of the user who read the post.';
$string['privacy:metadata:overflow_subscriptions'] = 'Information about subscriptions to forums. This includes which forums a user has subscribed.';
$string['privacy:metadata:overflow_subscriptions:overflow'] = 'The ID of the overflow forum the user has subscribed.';
$string['privacy:metadata:overflow_subscriptions:userid'] = 'The ID of the user who has subscribed a forum.';
$string['privacy:metadata:overflow_tracking'] = 'Information about the tracking of forums. This includes which forums a user does not track.';
$string['privacy:metadata:overflow_tracking:overflowid'] = 'The ID of the overflow forum that is not tracked by the user.';
$string['privacy:metadata:overflow_tracking:userid'] = 'The ID of the user who does not track the forum.';
...
$string['smallmessage'] = '{$a->user} posted in {$a->overflowname}';
...
$string['taskcleanreadrecords'] = 'Overflow maintenance job to clean old read records';
$string['tasksenddailymail'] = 'Overflow job to send a daily mail of unread post';
$string['tasksendmails'] = 'Overflow maintenance job to send mails';
$string['taskupdategrades'] = 'Overflow maintenance job to update grades';
...
$string['trackoverflow'] = 'Track unread posts';
...
$string['save_overflow'] = 'Saved forum successful!';
$string['confirmdelete'] = 'Deleted forum successful!';
$string['overflow:admin'] = 'Overflow Admin';